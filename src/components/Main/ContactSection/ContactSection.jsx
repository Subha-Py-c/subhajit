          ...
          <div className="adjuster-div flex">
            ...
            <div className="fs-contacts flex-col">
              <ul>
                <li className="animated-underline-white">
                  <a className="" href="mailto:demoemailforportfolio1@gmail.com">
                    <svg
                ...
                <li className="animated-underline-white">
                  ...
                  >
                    ...
                    <span className="s4">
                      <span className="s5"> X (twitter) </span>
                    </span>
                  </a>
                </li>
              </ul>
            ...
            <div id="email-box" className="email-box">
              ...
              <span className="question"
                >Have something to share? CLICK HERE! <br /><br />
              ...
              <div className="box ta-taX flex-col">
                ...
                >
                  ...
                  <div className="name-and-email-input flex-col">
                    <div className="nm">
                      <label for="emailer_name">Your name:</label>
                      <input
                        type="text"
                        name="name"
                        id="emailer_name"
                    ...
                    <div className="eml">
                      <label for="email"
                        >Email address for me to contact you:</label
                      >
                      <input
                        type="email"
                        id="email"
                  ...
                  <div className="btnCon">
                    ...
                    <div className="back-btn flexed">
                      <img width="24" height="24" src="icons/back-btn.svg" />
                    </div>
                  </div>
                </form>
              </div>
