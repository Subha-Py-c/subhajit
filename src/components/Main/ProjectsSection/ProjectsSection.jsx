        ...
        <div className="projects-wrapper full">
          ...
          <div className="project project1">
            <div className="project__data">
              ...
              <details>
                ...
                advertisements, along with summary of each news available. Many
                other mindblowing features available.
                <em>-- Solo Project</em>
                Technologies used:
                <ul>
          ...
          <div className="project project2">
            <div className="project__data">
              <h2>encryptease</h2>
              <details>
                <summary>Encrypt your data easily. (fun app)</summary>
                A powerful webapp to encrypt messages and files easily that are
                highly secure and cannot be decrypted without the encryption
                KEY.
                <em>-- Solo Project</em>
                Technologies used:
                <ul>
          ...
          <div className="project project3">
            <div className="project__data">
              <h2>Portfolio</h2>
              <details>
                <summary>This portfolio website you are in right now.</summary>
          ...
          <div className="project project4">
            <div className="project__data">
              ...
              <details>
                <summary>A retro blogging site for everyone.</summary>
                Currently IN MAKING. various blogs and journals will be
                published here later on.
          ...
          <div className="project project5">
            <div className="project__data">
              <h2>Zentunes</h2>
              <details>
                <summary>Ear-soothing music anywhere.</summary>
                A music streaming platform for retro lovers.
                <em>-- Solo Project.</em>
