            ...
            <div className="card-container">
              <div className="card">
                ...
                <div data-value="70%" className="card-elem">
                  <p>
                    <em><mark>Web Development</mark></em>
                  </p>
                  <em><u>Frontend:</u></em>
                  <br />
                ...
                <div data-value="85%" className="card-elem">
                  <p>
                    <em><mark>Data Structures</mark></em>
                    <!-- and Algorithms -->
                  </p>
                  <em><u>Languages:</u></em>
                  <br />
                  ...
                  Stack, Queue, LinkedList, Tree, Searching, Sorting
                  <br />
                  <br />
                  <span className="progress-bar flexed">
                    <span className="growth"></span>
                ...
                <div data-value="85%" className="card-elem">
                  ...
                  <br />
                  <em
                    ><u>Some libraries I have used in personal projects:</u></em
                  >
                  <br />
                  • numpy, matplotlib, PIL, Tesseract, OpenCV, reportlab, bs4,
                  selenium etc
                  <br />
                  <br />
                  <span className="progress-bar flexed">
                ...
                <div data-value="70%" className="card-elem">
                  <p>
                    <em><mark>Collaboration</mark></em>
                  </p>
                  Can easily collaborate with team members using GitHub
                  <br />
                  <em><u>Collaboration experience:</u></em>
                  <br />
                ...
                <div data-value="50%" className="card-elem">
                  <p>
                    <em><mark>Telegram Bots</mark></em>
                  </p>
                  I have created several telgram bots.
                  <br />
                  <br />
                  <p>
                    <em><mark>Scripting</mark></em>
                  </p>
                  Linux and MAC OS shell scripting, and python Scripting for
                  automation
                  <br />
                  <br />
                  <span className="progress-bar flexed">
